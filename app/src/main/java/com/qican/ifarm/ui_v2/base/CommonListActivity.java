...
public abstract class CommonListActivity<T> extends Activity implements View.OnClickListener, PullToRefreshLayout.OnRefreshListener {
    ...
    public void showError() {
        if (avi.getVisibility() == View.VISIBLE) avi.smoothToHide();
        ivNetError.setVisibility(View.GONE);
    }
