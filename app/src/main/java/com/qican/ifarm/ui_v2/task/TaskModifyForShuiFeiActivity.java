...
public class TaskModifyForShuiFeiActivity extends BaseActivityWithTitlebar implements PopwindowListener<Object, Object>, OnInfoListener<Task>, DialogForSelectNum.NumListener {
    ...
    public void init() {
        ...
        if (mTask.getControlOperation() != null)
            switch (mTask.getControlOperation()) {
                case "irrigate":
                    operation = "灌溉";
    ...
    private void initDatas() {
        ...
        setTextById(R.id.tv_can, mTask.getCanNo());
        setTextById(R.id.tv_area, mTask.getControlArea());
        tvLastTime.setText(TimeUtils.getTimeFromNum(lastTime));
    }

    private void saveModify() {
        if (mTask.getControlOperation() == null) return;
