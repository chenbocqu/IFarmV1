...
public class TaskModifyActivity extends BaseActivityWithTitlebar implements PopwindowListener<Object, Object> {
    ...
    public void init() {
        ...
        setRightMenu("确定修改", new View.OnClickListener() {
            @Override
    ...
    private void initDatas() {
        String executionTime = getTimeFromNum(Integer.parseInt(mTask.getExecutionTime()));
        tvStartTime.setText(getStartTime(mTask.getStartExecutionTime()));
        tvLastTime.setText(executionTime);
        tvOperation.setText(mTask.getName());

        commandCategory = mTask.getCommandCategory();
        lastTime = Integer.parseInt(mTask.getExecutionTime());
    }
    ...
    private void saveModifies() {
        ...
        if (!"ImmediateExecution".equals(commandCategory) && modifyTime)
    ...
    private void initOperations() {
        ...
        // 自编选项
        operationses = IFarmFakeData.getOperationsByCode(mTask.getSysTypeCode());
        ...
        OkHttpUtils.post().url(myTool.getServAdd() + "farmControl/farmControlOperationList")
                ...
                .addParams("systemId", mTask.getSystemId())
                .build()
