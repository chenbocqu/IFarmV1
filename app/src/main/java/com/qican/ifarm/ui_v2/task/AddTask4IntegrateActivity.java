...
public class AddTask4IntegrateActivity extends BaseActivityWithTitlebar implements PopwindowListener<Object, Object> {
    ...
    private void addNewTask() {
        ...
        mTask.setName(mSys.getControName() + "[" + mOpera.getName() + "]");
