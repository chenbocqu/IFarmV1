...
public class TaskTimeDisplayer {
    ...
    public TaskTimeDisplayer(Context mContext) {
        this(mContext, null);
    }

    public TaskTimeDisplayer(Context mContext, Task mTask) {
    ...
    public void showStatus(Task task) {
        if (task == null) return;
        if (task.getTaskState() == null) return;
        resetUI();
    ...
    public TaskTimeDisplayer setTaskTime(String time) {
        tvTaskTime.setText(time);
        return this;
    }

    public TaskTimeDisplayer setStartTime(String time) {
        tvStartTime.setText(time);
        return this;
    }

    public TaskTimeDisplayer setCompleteTime(String time) {
